      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-3">
            <img src="/images/logo.png" alt="AscentisTech" className="h-20 w-auto brightness-0 invert" />
            <p className="text-sm text-blue-200 leading-relaxed">{t('footer.slogan')}</p>
            <p className="text-xs text-blue-300">AscentisTech Pte. Ltd. Taiwan Branch</p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://www.linkedin.com/company/%E6%98%87%E6%96%B0%E7%A7%91%E6%8A%80-ascentistech/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-blue-100 hover:text-white transition-colors"
              >
